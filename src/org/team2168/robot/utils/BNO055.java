...
public class BNO055 {
	...
	private volatile double[] zeros = new double[3];
...
//					+ ", next: " + nextTime);
	...
	public double[] getVector() {
		//TODO: account for zero position set through the reset method.
		return xyz;
	}
	...
	public double getHeading() {
		return (xyz[0] + (turns * 360)) - zeros[0];
	}
	
	/**
	 * Sets the current sensor position to zero on all axis [0,0,0]. 
	 */
	public void reset() {
		resetHeading();
		zeros[1] = xyz[1];
