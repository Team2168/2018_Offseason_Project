 ...
 *@author Elijah Reeds
 */
public class AutomaticGearIntakeDANGEROUS extends CommandGroup {

    public AutomaticGearIntakeDANGEROUS() {
        // Add Commands here:
    	...
    	addSequential(new DriveGearIntakeRollerWithConstant(RobotMap.GEAR_INTAKE_SPEED_CONSTANT));
