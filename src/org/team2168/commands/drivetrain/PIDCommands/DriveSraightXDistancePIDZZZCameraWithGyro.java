 ...
 * @author Vittorio
 */
public class DriveSraightXDistancePIDZZZCameraWithGyro extends Command {
    ...
    public DriveSraightXDistancePIDZZZCameraWithGyro() {
    ...
    public DriveSraightXDistancePIDZZZCameraWithGyro(double setPoint){
 	   this();
 	   this.setPoint = setPoint;
    }

    public DriveSraightXDistancePIDZZZCameraWithGyro(double setPoint, double maxSpeed){
  	   this(setPoint);
  	   this.maxSpeed = maxSpeed;
     }
    
    public DriveSraightXDistancePIDZZZCameraWithGyro(double setPoint, double maxSpeed, double minSpeed){
   	   this(setPoint, maxSpeed);
   	   this.minSpeed = minSpeed;
      }    

    public DriveSraightXDistancePIDZZZCameraWithGyro(double setPoint, double maxSpeed, double minSpeed, double error) {
    	this(setPoint, maxSpeed, minSpeed);
    	this.error = error;
    }
    
    public DriveSraightXDistancePIDZZZCameraWithGyro(double setPoint, double maxSpeed, double minSpeed, double error, boolean absolute) {
