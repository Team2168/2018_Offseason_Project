 ...
 * @author Wen Baid
 */
public class RotateTurretAnglePIDZZZWithCamAndIMU extends Command {
    ...
    public RotateTurretAnglePIDZZZWithCamAndIMU() {
    ...
    public RotateTurretAnglePIDZZZWithCamAndIMU(double setPoint){
 	   this();
 	   this.setPoint = setPoint;
    }

    public RotateTurretAnglePIDZZZWithCamAndIMU(double setPoint, double maxSpeed){
  	   this(setPoint);
  	   this.maxSpeed = maxSpeed;
     }
    
    public RotateTurretAnglePIDZZZWithCamAndIMU(double setPoint, double maxSpeed, double minSpeed){
   	   this(setPoint, maxSpeed);
   	   this.minSpeed = minSpeed;
      }    

    public RotateTurretAnglePIDZZZWithCamAndIMU(double setPoint, double maxSpeed, double minSpeed, double error) {
    	this(setPoint, maxSpeed, minSpeed);
    	this.error = error;
    }
    
    public RotateTurretAnglePIDZZZWithCamAndIMU(double setPoint, double maxSpeed, double minSpeed, double error, boolean absolute) {
	...
	protected void initialize() {
		if (!absolute)
			this.setPoint = Robot.turret.tcpCamSensor.getRotationAngle() + RobotMap.CAMERA_OFFSET_ANGLE;
	...
	protected void execute() {
		...
		Robot.turret.rotateTurretCameraController.setSetPoint(Robot.turret.tcpCamSensor.getRotationAngle());
