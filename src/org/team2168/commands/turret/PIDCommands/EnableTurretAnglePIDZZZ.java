 ...
 * @author Vittorio
 */
public class EnableTurretAnglePIDZZZ extends Command {
    ...
    public EnableTurretAnglePIDZZZ() {
    ...
    public EnableTurretAnglePIDZZZ(double setPoint){
 	   this();
 	   this.setPoint = setPoint;
    }

    public EnableTurretAnglePIDZZZ(double setPoint, double maxSpeed){
  	   this(setPoint);
  	   this.maxSpeed = maxSpeed;
     }
    
    public EnableTurretAnglePIDZZZ(double setPoint, double maxSpeed, double minSpeed){
   	   this(setPoint, maxSpeed);
   	   this.minSpeed = minSpeed;
      }    

    public EnableTurretAnglePIDZZZ(double setPoint, double maxSpeed, double minSpeed, double error) {
    	this(setPoint, maxSpeed, minSpeed);
    	this.error = error;
    	this.absolute = false;
    }
    
    public EnableTurretAnglePIDZZZ(double setPoint, double maxSpeed, double minSpeed, double error, boolean absolute) {
